    ...
    <div className="container mx-auto flex justify-between items-center">
       ...
       <div className="relative">
            ...
            <button className="absolute right-2 top-2 text-gray-500">
                ...
                <path fillRule="evenodd" d="M12.9 14.32a8 8 0 111.414-1.414l4.385 4.384a1 1 0 11-1.414 1.414l-4.385-4.384zM14 8a6 6 0 11-12 0 6 6 0 0112 0z" clipRule="evenodd" />
                </svg>
            </button>
       </div>
